...
const primaryItems: NavigationItem[] = [
  ...
  { label: '法律知识库', path: '/legal-knowledge', icon: Reading, roles: ['admin', 'company_admin'] },
  { label: '法律知识库', path: '/legal-search', icon: Reading, roles: ['legal_manager', 'legal', 'member', 'employee'] },
  { label: '团队与权限', path: '/users', icon: User, roles: ['admin', 'company_admin'] },
  { label: '系统管理', path: '/settings', icon: Setting, roles: ['admin', 'company_admin'] },
]
